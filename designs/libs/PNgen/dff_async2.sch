...
C {prof-morbius-rf-chip/designs/libs/PNgen/nand_2.sym} -190 -70 0 0 {name=x1}
C {prof-morbius-rf-chip/designs/libs/PNgen/nand_2.sym} -190 80 0 0 {name=x2}
C {prof-morbius-rf-chip/designs/libs/PNgen/nand_2.sym} 190 -70 0 0 {name=x3}
C {prof-morbius-rf-chip/designs/libs/PNgen/nand_2.sym} 190 80 0 0 {name=x4}
C {prof-morbius-rf-chip/designs/libs/PNgen/nand_2.sym} 0 230 0 0 {name=x5}
C {prof-morbius-rf-chip/designs/libs/PNgen/nand_2.sym} 0 -70 0 0 {name=x6}
C {prof-morbius-rf-chip/designs/libs/PNgen/nand_2.sym} 0 80 0 0 {name=x7}
C {prof-morbius-rf-chip/designs/libs/PNgen/nand_2.sym} -430 90 0 0 {name=x10}
C {prof-morbius-rf-chip/designs/libs/PNgen/nand_2_out.sym} 390 -70 0 0 {name=x8}
C {prof-morbius-rf-chip/designs/libs/PNgen/nand_2_out.sym} 390 80 0 0 {name=x9}
