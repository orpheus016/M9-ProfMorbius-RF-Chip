...
N -190 -80 -190 -70 {lab=OUT[3]}
N -190 -50 -190 -40 {lab=#net1}
...
C {prof-morbius-rf-chip/designs/libs/PNgen/mux2_1.sym} -660 130 0 0 {name=x1}
C {prof-morbius-rf-chip/designs/libs/PNgen/dff_async2.sym} -530 150 0 0 {name=x2}
C {prof-morbius-rf-chip/designs/libs/PNgen/mux2_1.sym} -390 150 0 0 {name=x3}
C {prof-morbius-rf-chip/designs/libs/PNgen/dff_async2.sym} -260 170 0 0 {name=x4}
C {prof-morbius-rf-chip/designs/libs/PNgen/mux2_1.sym} -110 170 0 0 {name=x5}
C {prof-morbius-rf-chip/designs/libs/PNgen/dff_async2.sym} 20 190 0 0 {name=x6}
C {prof-morbius-rf-chip/designs/libs/PNgen/mux2_1.sym} 160 190 0 0 {name=x7}
C {prof-morbius-rf-chip/designs/libs/PNgen/dff_async2.sym} 290 210 0 0 {name=x8}
C {prof-morbius-rf-chip/designs/libs/PNgen/mux2_1.sym} -80 30 1 1 {name=x9}
C {prof-morbius-rf-chip/designs/libs/PNgen/xor.sym} -260 -60 0 1 {name=x10}
