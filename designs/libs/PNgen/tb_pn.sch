...
C {devices/lab_pin.sym} -410 -350 0 0 {name=p11 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -410 -330 0 0 {name=p20 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -410 -310 0 0 {name=p25 sig_type=std_logic lab=PN_SEL}
C {devices/lab_pin.sym} -410 -290 0 0 {name=p26 sig_type=std_logic lab=SEED_0}
C {devices/lab_pin.sym} -410 -270 0 0 {name=p27 sig_type=std_logic lab=SEED_1}
C {devices/lab_pin.sym} -410 -250 0 0 {name=p28 sig_type=std_logic lab=SEED_2}
C {devices/lab_pin.sym} -410 -230 0 0 {name=p29 sig_type=std_logic lab=SEED_3}
C {devices/lab_pin.sym} -410 -210 0 0 {name=p30 sig_type=std_logic lab=CLK}
C {devices/lab_pin.sym} -410 -190 0 0 {name=p31 sig_type=std_logic lab=RST}
C {devices/lab_pin.sym} -110 -350 2 0 {name=p32 sig_type=std_logic lab=OUT_0}
C {devices/lab_pin.sym} -110 -330 2 0 {name=p33 sig_type=std_logic lab=OUT_1}
C {devices/lab_pin.sym} -110 -310 2 0 {name=p34 sig_type=std_logic lab=OUT_2}
C {devices/lab_pin.sym} -110 -290 2 0 {name=p35 sig_type=std_logic lab=OUT_3}
C {prof-morbius-rf-chip/designs/libs/PNgen/pn_seqgen.sym} -260 -270 0 0 {name=x1}
